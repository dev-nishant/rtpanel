			...
			<div class="row">
				...
				<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
					...
					<ul class="font-14">
						...
						<li>
							<i class="fa fa-angle-right" aria-hidden="true"></i>
							<a href="www.devilsworkshop.org">www.devilsworkshop.org</a>
						</li>
						<li>
							<i class="fa fa-angle-right" aria-hidden="true"></i>
							<a href="www.rtpanel.com">www.rtpanel.com</a>
						</li>
						<li>
							<i class="fa fa-angle-right" aria-hidden="true"></i>
							<a href="www.bloggertowp.com">www.bloggertowp.com</a>
						</li>
						<li>
							<i class="fa fa-angle-right" aria-hidden="true"></i>
							<a href="www.wpngnix.com">www.wpngnix.com</a>
						</li>
					</ul>
				</div>
				<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 foot-col-logo text-center">
					...
					<ul class="font-14">
						...
						<li> Designed by <a href="www.rtcamp.com">rtCamp</a></li>
					</ul>
				</div>
			</div>
		</div>
